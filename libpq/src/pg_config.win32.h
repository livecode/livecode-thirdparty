...
#define PG_VERSION_STR "PostgreSQL 9.4.5, compiled by Visual C++ build " __STRINGIFY2(_MSC_VER) ", 32-bit"
...
#define VAL_CONFIGURE "--enable-thread-safety --enable-integer-datetimes --with-ldap --without-zlib --with-python"
