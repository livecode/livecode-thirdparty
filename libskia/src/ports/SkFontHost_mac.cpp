...
void SkScalerContext_Mac::generateImage(const SkGlyph& glyph) {
    ...
    if (isLCD || (glyph.fMaskFormat == SkMask::kA8_Format && smooth_behavior() != SmoothBehavior::none)) {
